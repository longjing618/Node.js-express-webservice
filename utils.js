var utils = {};
utils.unserialize = function(data) {
...
utils.getjsonvalue = function(data,key)
{
   var re = new Array();
   for(d1 in data)
     for(d2 in data[d1])
     {   
       if(typeof data[d1][d2][key] != 'undefined')
         re[re.length]=data[d1][d2][key];
       else
       {
         console.log('Cannot get value: '+key);
         re[re.length] = "";
       }
     }   
   return re;
